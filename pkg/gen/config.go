...
type Config struct {
	...
	RepoPath    string //基础路经
	ServicePath string //基础路经
	HandlerPath string //基础路经

	BasePkgPath  string //基础路经
	...
	EnableModelOverride   bool
	EnableRepoOverride    bool
	EnableServiceOverride bool
	EnableHandleOverride  bool
...
func (cfg *Config) Revise() (err error) {
	if strings.TrimSpace(cfg.ModelPath) == "" {
		cfg.ModelPath = model.DefaultModelPkg
	}

	if strings.TrimSpace(cfg.BasePkgPath) == "" {
		cfg.BasePkgPath = model.DefaultModelPkg
	}
